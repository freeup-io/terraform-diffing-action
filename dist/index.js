...
const finder = __importStar(__webpack_require__(420));
function run() {
...
exports.getStatus = () => __awaiter(void 0, void 0, void 0, function* () {
    const commit = yield exports.git.log(['-1']);
    return commit;
});
exports.getRevision = () => __awaiter(void 0, void 0, void 0, function* () {
    const rev = yield exports.git.revparse(['--short', 'HEAD']);
    return rev;
});
exports.getDiffScripts = () => __awaiter(void 0, void 0, void 0, function* () {
    const cmdOptions = [
        '--',
        `${exports.ROOT_DIR}/.git*`,
        `${exports.ROOT_DIR}/scripts`
    ];
...
exports.getDiffEnvs = () => __awaiter(void 0, void 0, void 0, function* () {
    const cmdOptions = [
        '--',
        `${exports.ROOT_DIR}/terraform/envs/${exports.ENV}.tfvars`
    ];
    const diff = yield getDiff(cmdOptions);
    const diffedFiles = diff.files.map(elem => elem.file);
    core.info(`diff options: ${cmdOptions}`);
...
exports.getDiffComponentEnvs = () => __awaiter(void 0, void 0, void 0, function* () {
    const cmdOptions = [
        '--',
        `${exports.ROOT_DIR}/terraform/components/*/envs/*`
    ];
    const diff = yield getDiff(cmdOptions);
    const diffedFiles = diff.files.map(elem => elem.file);
    core.info(`diff options: ${cmdOptions}`);
...
exports.getDiffComponents = () => __awaiter(void 0, void 0, void 0, function* () {
    const cmdOptions = [
        '--',
        `${exports.ROOT_DIR}/terraform/components`,
        ':!*/envs/*'
    ];
    const diff = yield getDiff(cmdOptions);
...
function isEnvInComponent(component) {
    const path = `${exports.ROOT_DIR}/terraform/components/${component}/envs/${exports.ENV}.tfvars`;
    return fs_1.default.existsSync(path);
}
exports.isEnvInComponent = isEnvInComponent;
